    ...
    <div className="border border-latte rounded-lg p-4 bg-white shadow-sm">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-cinnamon border border-cinnamon rounded"></div>
          <span className="text-sm">Официален празник</span>
        </div>
        {/* 2. Personal Vacation */}
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-vacation-bg rounded"></div>
        ...
        {/* 4. School Holidays */}
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-school-bg rounded"></div>
          <span className="text-sm">Неучебни дни / Ученически ваканции</span>
        </div>
        {/* 5. Weekend */}
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-cream rounded"></div>
