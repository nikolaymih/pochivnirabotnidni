...
```css
--color-teal: #CBD0B5;            /* School holidays */
--color-school-bg: #CBD0B5;       /* Light teal background */
```
...
const dayClasses = [
  ...
  !isHighlighted && !isHoliday && !isVacation && isSchoolHoliday && 'bg-school-bg text-black',
