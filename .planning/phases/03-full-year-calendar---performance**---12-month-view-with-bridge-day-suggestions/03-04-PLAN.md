...
must_haves:
  truths:
    - "Calendar loads within 3 seconds on mobile devices"
    - "Initial render completes within 200ms"
    - "No layout shifts during page load"
    - "Vacation marking interaction feels immediate"
    - "Bridge day suggestions display without delay"
  artifacts:
...
```
  ...
  <done>
- IF performance targets not met: Optimizations applied based on severity
- IF performance targets met: No changes needed (document in 03-PERFORMANCE.md)
- Re-measurement confirms optimization impact
- 03-PERFORMANCE.md updated with final results
  </done>
</task>
